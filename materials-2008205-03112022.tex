...
\begin{tabular}{cc}
	...
	\end{tabular}
        \caption{Application %MDPI: Please change the hyphen (-) into minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". -- Answer: ok we agree, but there is no hyphen in this phrase "Application of simplex lattice design showing possible binder combinations". Above in graphical illustration, not text.
