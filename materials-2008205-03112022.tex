...
% --------------------------------- ANSWER  --------------------------------- %
%-- Answer:  Ok, we have read and understand all your notes. Our replies are marked as "-- Answer: agree (or reply)... " just next to your comments. After we agree with your comments, the yellow highlighting is deleted, but your comments remained as you requested.
% Also, we have added a section: Short Biography of Authors on p. 26.
...
\begin{tabular}{cc}
	...
	\end{tabular}
        \caption{Application %MDPI: Please change the hyphen (-) into minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". -- Answer: ok we agree, but there is no hyphen in this phrase "Application of simplex lattice design showing possible binder combinations". We don't understand what is needed. The above is a figure, it is not a text, it is not possible to change it by LaTeX commands. Please change what is necessary, we agree.
...
\begin{tabular}{cc}
	...
	(\textbf{a}) & (\textbf{b})
	\end{tabular}
        \caption{An example %MDPI: Please replace with a sharper image for subfigure b. ---- Answer: corrected (Fig. 5b is replaced by the original with higher resolution).
...
{\textbf{Per Lindh} is a Senior Specialist in Swedish Transport Administration and an Adjunct Senior Lecturer (PhD) at Lund University. He is a Civil Engineer with a sound experience in soil stabilization with cementitious binders and stabilization of contaminated sediments. His area of expertise includes soil mechanics, evaluation of compressive strength by statistical and seismic methods for sustainable ground constructions and building. He controls measurements of the properties of materials, soil and foundations in geotechnical projects on highway, asphalt road and pavement constructions.} 
%
\bio
