...
\begin{tabular}{cc}
	...
	\end{tabular}
        \caption{Application %MDPI: Please change the hyphen (-) into minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". -- Answer: ok, we agree. We changed hyphens to "minus" signs (long dash) in Fig. 04a and Fig. 04b.
